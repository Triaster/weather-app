const link = "http://api.weatherstack.com/current?access_key=2cadfcda778e0395b2b808dd52509db3";
...
const markup = () => {
    ...
    <div class="top">
        <div class="city">
            <div class="city-subtitle">Weaher Today in</div>
        ...
        <div class="city-info">
            <div class="top-left">
                <img class="icon" src="./img/${getImge(description)}" alt="">
